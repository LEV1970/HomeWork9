...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        students.add(new Student("Jhon", Arrays.asList(new Course("Math"), new Course("Biology"),
                new Course("Testing"))));
        students.add(new Student("Jimmy", Arrays.asList(new Course("Math"), new Course("Geography"),
                new Course("Economic"), new Course("Medicine"))));
        students.add(new Student("Mike", Arrays.asList(new Course("Physics"), new Course("Biology"),
                new Course("Testing"), new Course("Philosophy"))));
